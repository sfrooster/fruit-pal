...
class appInternal {
    ...
    private routes(): void {
        ...
        router.get('/fruit/:canonicalFruitName', (req: express.Request, res: express.Response, next: {}) => {
            try {
                // validate fruit against list
                // look for fruit with cheapest variable cost
                // return
...
export default new appInternal();